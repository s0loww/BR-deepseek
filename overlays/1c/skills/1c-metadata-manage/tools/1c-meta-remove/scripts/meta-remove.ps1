...
if ($DryRun) {
	Write-Host "[DRY-RUN] No changes will be made. Re-run with -Apply to perform the removal."
	Write-Host ""
}
...
if ($DryRun) {
	...
	Write-Host "No changes made. Re-run with -Apply to perform the removal."
} else {
