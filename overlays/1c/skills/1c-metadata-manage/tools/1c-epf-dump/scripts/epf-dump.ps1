...
.EXAMPLE
    .\epf-dump.ps1 -InfoBasePath "<infobase-dir>" -InputFile "build\МояОбработка.epf" -OutputDir "src"

.EXAMPLE
    .\epf-dump.ps1 -InfoBasePath "<infobase-dir>" -InputFile "build\МойОтчёт.erf" -OutputDir "src"
#>
