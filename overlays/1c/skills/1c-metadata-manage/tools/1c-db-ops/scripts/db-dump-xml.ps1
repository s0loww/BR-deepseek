...
.EXAMPLE
    .\db-dump-xml.ps1 -InfoBasePath "<infobase-dir>" -ConfigDir "<config-dir>" -Mode Full

.EXAMPLE
    .\db-dump-xml.ps1 -InfoBasePath "<infobase-dir>" -ConfigDir "<config-dir>" -Mode Partial -Objects "Справочник.Номенклатура,Документ.Заказ"
#>
